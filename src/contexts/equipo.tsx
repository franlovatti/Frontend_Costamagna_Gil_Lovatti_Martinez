...
export interface EquipoContextType {
    ...
    crearEquipo : (payload: EquiposPayload) => Promise<void>;
    inscribirseEquipo : (equipo: Equipo, contrseña: string, usuarioId: number) => Promise<boolean>;
    salirEquipo : (equipoId: number, usuarioId: number) => Promise<boolean>;
    obtenerEquipo : (equipoId: number) => Promise<Equipo>;
    editarEquipo : (equipoId: number, payload: EquipoEditPayload) => Promise<void>;
    removerMiembro : (equipoId: number, usuarioId: number) => Promise<void>;
}

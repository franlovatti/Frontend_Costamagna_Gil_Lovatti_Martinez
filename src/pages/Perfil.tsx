...
const Perfil = () => {
  ...
  function calcularEstadisticas(e: typeof equipos) {
    const datos = e.map(equip => {
      ...
      return {
        ...
        partidosPendientes: torneo.partidos?.filter(p => 
            (p.equipoLocal.id === equip.id || p.equipoVisitante.id === equip.id) &&
    ...
    const partidosPendientes = datos.reduce((acc, d) => acc + d.partidosPendientes, 0);
  ...
  const stats = [
    ...
    { icon: '✅',
      value: torneosTerminados,
      title: 'Torneos terminados' 
    },
    { icon: '🎯',
    ...
    <div className="perfil-page">
      <div className="container-perfil">
        ...
        <div className="perfil-header mb-4">
          ...
          <p className="text-muted-custom mb-0">Administra tu información y revisa tu historial</p>
        </div>
